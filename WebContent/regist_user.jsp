...
function checkpwd(){
	  var p1=document.form1.regist_password.value;//获取密码框的值
...
with (thisform)
  {
  if (validate_required(regist_uname,"请输入用户名")==false)
    {regist_uname.focus();return false}
  ...
  if (validate_required(regist_birth,"请输入出生日期")==false)
	  {accept.focus();return false}
...
-->
<div class="alsp" id="Layer1" style="position:absolute; width:100%; height:200px; z-index:-1; overflow: auto; left: 0px; top: 144px;">  
...
<center>
   ...
   <form action="/TheFinalProject/base/uploadPhoto" method="post" enctype="multipart/form-data">
                文件:<input type="file" name="uploadFile"/><br/><br/>
      <input type="submit" value="上传"/>
   </form>
 </center>
<form name="form1" action="/TheFinalProject/base/adduser" onSubmit="return validate1_form(this)" method="post">
  <div align="center">
    ...
    <div align="center">
      ...
      <td><input type="password" name="confirmpass" onChange="checkpwd()"/></td>
			...
			<tr>
          	<td>用户名：</td>
      		<td><input type="text" name="regist_uname" value="Test"/></td>
      </tr>
        <tr>
          	<td>电子邮箱：</td>
      		<td><input type="text" name="regist_email" value="1234@56.789"/></td>
     </tr>
  		<tr>
  			<td>电话：</td>
  			<td><input type="text" name="regist_phone" value="123456789"/></td>
  		</tr>
        <tr>
        	<td>生日：</td>
        	<td><input type="text" name="regist_birth" value="1234-01-01"/>(请输入格式为"yyyy-mm-dd")</td>
        </tr>
        <tr>
          <td>性别：</td>
