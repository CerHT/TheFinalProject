		...
		<table>
			<tr>
				<td colspan="6" align="center" bgcolor="#5BA8DE">共${page.totalRecords}条记录
					...
					href="<%=request.getContextPath()%>/manager/checkBussiness?pageNo=${page.topPageNo}"><input
						type="button" name="fristPage" value="首页" /></a> <c:choose>
						<c:when test="${page.pageNo!=1}">
							<a
								href="<%=request.getContextPath()%>/manager/checkBussiness?pageNo=${page.previousPageNo }"><input
						...
						<c:when test="${page.pageNo != page.totalPages}">
							<a
								href="<%=request.getContextPath()%>/manager/checkBussiness?pageNo=${page.nextPageNo }"><input
					...
					href="<%=request.getContextPath()%>/manager/checkBussiness?pageNo=${page.bottomPageNo}"><input
