...
<frame src="${pageContext.request.contextPath }/manager/welcomeManager.jsp" scrolling="auto" />

<frameset cols="15%,85%" frameborder="yes" framespacing="1">
<frame src="${pageContext.request.contextPath }/manager/menuManager.jsp" name="left" id="left" title="leftFrame"  scrolling="auto">
